...
data = [
    ...
    dict(
        dimensions="*",
        domain=[-32, 32],
        domain_latex=r"xi ∈ [-32.768, 32.768], for all i = 1, …, d, although it may also be restricted to a smaller domain",
        latex=r"f_{\text{Ackley}}(\mathbf{x}) = -20e^{-0.2 \sqrt{\frac{1}{n} \sum_{i=1}^n x_i^2}} - e^{ \frac{1}{n} \sum_{i=1}^n \cos(2 \pi x_i)} + 20 + e",
        links=[
        ...
        minima={r"f(x_i)": 0, r"x_i": 0},
        minima_latex=r"f(x_i) = 0 for x_i = 0 for i=1,...,n",
        name="Ackley",
        references=[
    ...
    dict(
        dimensions=2,
        domain=[-1, 2],
        domain_latex=r"x_1 \in [-1, 2], x_2 \in [-1, 1]",
        latex=r"f_{\text{Adjiman}}(\mathbf{x}) = \cos(x_1)\sin(x_2) - \frac{x_1}{(x_2^2 + 1)}",
        links=[
        ...
        minima={r"f(x_i)": -2.02181, r"\mathbf{x}": [2, 0.10578]},
        minima_latex=r"f(x_i) = -2.02181 for \mathbf{x} = [2, 0.10578]",
        name="Adjiman",
        references=[
            "Momin Jamil and Xin-She Yang, A literature survey of benchmark functions for global optimization problems, Int. Journal of Mathematical Modelling and Numerical Optimisation}, Vol. 4, No. 2, pp. 150--194 (2013), [arXiv:1308.4008",
    ...
    dict(
        ...
        latex=r"f_{\text{Alpine01}}(\mathbf{x}) = \sum_{i=1}^{n} \lvert {x_i \sin \left( x_i \right) + 0.1 x_i} \rvert",
        links=[
    ...
    dict(
        dimensions="*",
        domain=[0, 10],
        domain_latex=r"x_i \in [0, 10], i=1,...,n",
        latex=r"f_{\text{Alpine02}}(\mathbf{x}) = \prod_{i=1}^{n} \sqrt{x_i} \sin(x_i)",
        links=[
        ...
        minima={r"f(x_i)": -6.1295, r"x_i": 7.917},
        minima_latex=r"f(x_i) = -6.1295 for x_i = 7.917 for i=1,...,n",
        name="Alpine 2",
        references=[
            "Momin Jamil and Xin-She Yang, A literature survey of benchmark functions for global optimization problems, Int. Journal of Mathematical Modelling and Numerical Optimisation}, Vol. 4, No. 2, pp. 150--194 (2013), [arXiv:1308.4008",
            "M. Clerc, “The Swarm and the Queen, Towards a Deterministic and Adaptive Particle Swarm Optimization, ” IEEE Congress on Evolutionary Computation, Washington DC, USA, pp. 1951-1957, 1999",
    ...
    dict(
        dimensions=2,
        domain=[-50, 50],
        domain_latex=r"x_i \in [-50, 50], i=1,...,n",
        latex=r"f_{\text{BartelsConn}}(\mathbf{x}) = \lvert {x_1^2 + x_2^2 + x_1x_2} \rvert + \lvert {\sin(x_1)} \rvert + \lvert {\cos(x_2)} \rvert",
        links=[
        ...
        minima={r"f(x_i)": 1, r"x_i": 0},
        minima_latex=r"f(x_i) = 1 for x_i = 0 for i=1,...,n",
        name="Bartels Conn",
        references=[
            "Momin Jamil and Xin-She Yang, A literature survey of benchmark functions for global optimization problems, Int. Journal of Mathematical Modelling and Numerical Optimisation}, Vol. 4, No. 2, pp. 150--194 (2013), [arXiv:1308.4008",
        ],
    ...
    dict(
        dimensions=2,
        domain=[-10, 10],
        domain_latex=r"xi ∈ [-4.5, 4.5], for all i = 1, 2",
        latex=r"f_{\text{Beale}}(\mathbf{x}) = \left(x_1 x_2 - x_1 + 1.5\right)^{2} + \left(x_1 x_2^{2} - x_1 + 2.25\right)^{2} + \left(x_1 x_2^{3} - x_1 + 2.625\right)^{2}",
        links=[
        ...
        minima={r"f(x_i)": 0, r"\mathbf{x}": [3, 0.5]},
        minima_latex=r"f(x_i) = 0 for \mathbf{x} = [3, 0.5]",
        name="Beale",
        references=[
    ...
    dict(
        ...
        domain_latex=r"x_i \in [-2\pi, 2\pi], i=1,2",
        latex=r"f_{\text{Bird}}(\mathbf{x}) = \left(x_1 - x_2\right)^{2} + e^{\left[1 - \sin\left(x_1\right) \right]^{2}} \cos\left(x_2\right) + e^{\left[1 - \cos\left(x_2\right)\right]^{2}} \sin\left(x_1\right)",
        links=[
        ...
        minima={r"f(x_i)": -106.7645367198034, r"\mathbf{x}": [4.701055751981055 , 3.152946019601391]},
        minima_latex=r"f(x_i) = -106.7645367198034 for \mathbf{x} = [4.701055751981055 , 3.152946019601391] or\n\mathbf{x} = [-1.582142172055011, -3.130246799635430]",
        name="Bird",
        references=[
            "Momin Jamil and Xin-She Yang, A literature survey of benchmark functions for global optimization problems, Int. Journal of Mathematical Modelling and Numerical Optimisation}, Vol. 4, No. 2, pp. 150--194 (2013), [arXiv:1308.4008",
    ...
    dict(
        dimensions=2,
        domain=[-15, 15],
        domain_latex=r"xi ∈ [-100, 100], for all i = 1, 2",
        latex=r"f_{\text{Bohachevsky}}(\mathbf{x}) = \sum_{i=1}^{n-1}\left[x_i^2 + 2x_{i+1}^2 - 0.3\cos(3\pi x_i) - 0.4\cos(4\pi x_{i+1}) + 0.7\right]",
        links=[
    ...
    dict(
        dimensions=2,
        domain=[-10, 10],
        domain_latex=r"xi ∈ [-10, 10], for all i = 1, 2",
    ...
    dict(
        dimensions=2,
        domain=[-10, 10],
        domain_latex=r"x_i \in [-10, 10], i=1,2",
        latex=r"f_{\text{Brent}}(\mathbf{x}) = (x_1 + 10)^2 + (x_2 + 10)^2 + e^{(-x_1^2-x_2^2)}",
        links=[
        ...
        minima={r"f(x_i)": 0, r"\mathbf{x}": [-10, -10]},
        minima_latex=r"f(x_i) = 0 for \mathbf{x} = [-10, -10]",
        name="Brent",
        references=[
            "Momin Jamil and Xin-She Yang, A literature survey of benchmark functions for global optimization problems, Int. Journal of Mathematical Modelling and Numerical Optimisation}, Vol. 4, No. 2, pp. 150--194 (2013), [arXiv:1308.4008",
        ],
    ...
    dict(
        dimensions="*",
        domain=[-1, 4],
        domain_latex=r"x_i \in [-1, 4], i=1,...,n",
        latex=r"f_{\text{Brown}}(\mathbf{x}) = \sum_{i=1}^{n-1}\left[ \left(x_i^2\right)^{x_{i+1}^2+1} + \left(x_{i+1}^2\right)^{x_i^2+1} \right]",
        links=[
    ...
    dict(
        dimensions=2,
        domain=[-15, -5],
        domain_latex=r"x1 ∈ [-15, -5], x2 ∈ [-3, 3]",
        latex=r"f_{\text{Bukin06}}(\mathbf{x}) = 100 \sqrt{ \lvert{x_2 - 0.01 x_1^{2}} \rvert} + 0.01 \lvert{x_1 + 10} \rvert",
        links=[
        ...
        minima={r"f(x_i)": 0, r"\mathbf{x}": [-10, 1]},
        minima_latex=r"f(x_i) = 0 for \mathbf{x} = [-10, 1]",
        name="Bukin 6",
        references=[
    ...
    dict(
        ...
        domain=[-15, 15],
        domain_latex=r"xi ∈ [-10, 10], for all i = 1, 2",
        latex=r"f_{\text{CrossInTray}}(\mathbf{x}) = - 0.0001 \left(\left|{e^{\left|{100 - \frac{\sqrt{x_{1}^{2} + x_{2}^{2}}}{\pi}}\right|} \sin\left(x_{1}\right) \sin\left(x_{2}\right)}\right| + 1\right)^{0.1}",
        links=[
        ...
        minima={r"f(x_i)": -2.062611870822739, r"x_i": r"\pm 1.349406608602084"},
        minima_latex=r"f(x_i) = -2.062611870822739 for x_i = \pm 1.349406608602084 for i=1,2",
        name="Cross-in-Tray",
        references=[
    ...
    dict(
        dimensions=2,
        domain=[-20, 20],
        domain_latex=r"x_i \in [-20, 20], i=1,2",
        latex=r"f_{\text{DeckkersAarts}}(\mathbf{x}) = 10^5x_1^2 + x_2^2 - (x_1^2 + x_2^2)^2 + 10^{-5}(x_1^2 + x_2^2)^4",
        links=[
        ...
        minima={r"f(x_i)": -24777, r"\mathbf{x}": r"[0, \pm 15]"},
        minima_latex=r"f(x_i) = -24777 for \mathbf{x} = [0, \pm 15]",
        name="Deckkers-Aarts",
        references=[
            "Momin Jamil and Xin-She Yang, A literature survey of benchmark functions for global optimization problems, Int. Journal of Mathematical Modelling and Numerical Optimisation}, Vol. 4, No. 2, pp. 150--194 (2013), [arXiv:1308.4008",
    ...
    dict(
        dimensions=2,
        domain=[-5.12, 5.12],
        domain_latex=r"xi ∈ [-5.12, 5.12], for all i = 1, 2",
        latex=r"f_{\text{DropWave}}(\mathbf{x}) = - \frac{1 + \cos\left(12 \sqrt{\sum_{i=1}^{n} x_i^{2}}\right)}{2 + 0.5 \sum_{i=1}^{n} x_i^{2}}",
        links=[
        ...
        minima={r"f(x_i)": -1, r"x_i": 0},
        minima_latex=r"f(x_i) = -1 for x_i = 0 for i=1,2",
        name="Drop-Wave",
        references=[
            "Global Optimization Test Functions Index. Retrieved June 2013, from http://infinity77.net/global_optimization/test_functions.html#test-functions-index.",
    ...
    dict(
        ...
        domain=[-100, 100],
        domain_latex=r"xi ∈ [-100, 100], for all i = 1, 2",
        latex=r"f_{\text{Easom}}(\mathbf{x}) = a - \frac{a}{e^{b \sqrt{\frac{\sum_{i=1}^{n} x_i^{2}}{n}}}} + e - e^{\frac{\sum_{i=1}^{n} \cos\left(c x_i\right)}{n}}",
        links=[
        ...
        minima={r"f(x_i)": 0, r"x_i": 0},
        minima_latex=r"f(x_i) = 0 for x_i = 0 for i=1,2",
        name="Easom",
        references=[
            "Global Optimization Test Problems. Retrieved June 2013, from\nhttp://www-optima.amp.i.kyoto-u.ac.jp/member/student/hedar/Hedar_files/TestGO.htm.",
    ...
    dict(
        dimensions=2,
        domain=[-5, 5],
        domain_latex=r"x_i \in [-5, 5], i=1,2",
        latex=r"f_{\text{EggCrate}}(\mathbf{x}) = x_1^2 + x_2^2 + 25 \left[ \sin^2(x_1) + \sin^2(x_2) \right]",
        links=[
    ...
    dict(
        dimensions="*",
        domain=[-1, 1],
        domain_latex=r"x_i \in [-1, 1], i=1,...,n",
        latex=r"f_{\text{Exponential}}(\mathbf{x}) = -e^{-0.5 \sum_{i=1}^n x_i^2}",
        links=[
    ...
    dict(
        dimensions=2,
        domain=[-2, 2],
        domain_latex=r"xi ∈ [-2, 2], for all i = 1, 2",
        latex=r"f_{\text{GoldsteinPrice}}(\mathbf{x}) = \left[ 1+(x_1+x_2+1)^2(19-14x_1+3x_1^2-14x_2+6x_1x_2+3x_2^2) \right] \left[ 30+(2x_1-3x_2)^2(18-32x_1+12x_1^2+48x_2-36x_1x_2+27x_2^2) \right]",
        links=[
        ...
        minima={r"f(x_i)": 3, r"\mathbf{x}": [0, -1]},
        minima_latex=r"f(x_i) = 3 for \mathbf{x} = [0, -1]",
    ...
    dict(
        dimensions="*",
        domain=[-600, 600],
        domain_latex=r"xi ∈ [-600, 600], for all i = 1, …, d",
        latex=r"f_{\text{Griewank}}(\mathbf{x}) = \frac{1}{4000}\sum_{i=1}^n x_i^2 - \prod_{i=1}^n\cos\left(\frac{x_i}{\sqrt{i}}\right) + 1",
        links=[
    ...
    dict(
        dimensions=2,
        domain=[-6, 6],
        domain_latex=r"x_i \in [-6, 6], i=1,2",
        latex=r"f_{\text{HimmelBlau}}(\mathbf{x}) = (x_1^2 + x_2 - 11)^2 + (x_1 + x_2^2 -7)^2",
        links=[
        ...
        minima={r"f(x_i)": 0, r"\mathbf{x}": [0, 0]},
        minima_latex=r"f(x_i) = 0 for \mathbf{x} = [0, 0]",
        name="HimmelBlau",
        references=[
    ...
    dict(
        ...
        domain=[-10, 10],
        domain_latex=r"xi ∈ [-10, 10], for all i = 1, 2",
        latex=r"f_{\text{HolderTable}}(\mathbf{x}) = - \left|{e^{\left|{1 - \frac{\sqrt{x_{1}^{2} + x_{2}^{2}}}{\pi} }\right|} \sin\left(x_{1}\right) \cos\left(x_{2}\right)}\right|",
        links=[
        ...
        minima={r"f(x_i)": -19.20850256788675, r"x_i": r"\pm 9.664590028909654"},
        minima_latex=r"f(x_i) = -19.20850256788675 for x_i = \pm 9.664590028909654 for i=1,2",
        name="Holder Table",
        references=[
            "Global Optimization Test Functions Index. Retrieved June 2013, from http://infinity77.net/global_optimization/test_functions.html#test-functions-index.",
            "Test functions for optimization. In Wikipedia. Retrieved June 2013, from https://en.wikipedia.org/wiki/Test_functions_for_optimization.",
    ...
    dict(
        dimensions=2,
        domain=[0, 10],
        domain_latex=r"x_i \in [0, 10], i=1,2",
        latex=r"f_{\text{Keane}}(\mathbf{x}) = \frac{\sin^2(x_1 - x_2)\sin^2(x_1 + x_2)}{\sqrt{x_1^2 + x_2^2}}",
        links=[
        ...
        minima={r"f(x_i)": 0.673668, r"\mathbf{x}": [0.0, 1.39325]},
        minima_latex=r"f(x_i) = 0.673668 for \mathbf{x} = [0.0, 1.39325].",
        name="Keane",
        references=[
            "Momin Jamil and Xin-She Yang, A literature survey of benchmark functions for global optimization problems, Int. Journal of Mathematical Modelling and Numerical Optimisation}, Vol. 4, No. 2, pp. 150--194 (2013), [arXiv:1308.4008",
    ...
    dict(
        dimensions=2,
        domain=[-1.2, 1.2],
        domain_latex=r"x_i \in [-1.2, 1.2], i=1,2",
        latex=r"f_{\text{Leon}}(\mathbf{x}) = \left(1 - x_{1}\right)^{2} + 100 \left(x_{2} - x_{1}^{2} \right)^{2}",
        links=[
        ...
        minima={r"f(x_i)": 0, r"x_i": 1},
        minima_latex=r"f(x_i) = 0 for x_i = 1 for i=1,2",
        name="Leon",
        references=[
            "Momin Jamil and Xin-She Yang, A literature survey of benchmark functions for global optimization problems, Int. Journal of Mathematical Modelling and Numerical Optimisation}, Vol. 4, No. 2, pp. 150--194 (2013), [arXiv:1308.4008",
    ...
    dict(
        ...
        domain=[-10, 10],
        domain_latex=r"xi ∈ [-10, 10], for all i = 1, 2",
        latex=r"f_{\text{Levy03}}(\mathbf{x}) = \sin^2(\pi y_1)+\sum_{i=1}^{n-1}(y_i-1)^2[1+10\sin^2(\pi y_{i+1})]+(y_n-1)^2",
        links=[
        ...
        minima={r"f(x_i)": 0, r"x_i": 1},
        minima_latex=r"f(x_i) = 0 for x_i = 1 for i=1,...,n",
        name="Levi N. 13",
        references=[
            "Global Optimization Test Functions Index. Retrieved June 2013, from http://infinity77.net/global_optimization/test_functions.html#test-functions-index.",
    ...
    dict(
        ...
        domain=[-10, 10],
        domain_latex=r"xi ∈ [-10, 10], for all i = 1, 2",
        latex=r"f_{\text{Matyas}}(\mathbf{x}) = 0.26(x_1^2 + x_2^2) - 0.48x_1x_2",
        links=[
    ...
    dict(
        dimensions=2,
        domain=[-1.5, 4],
        domain_latex=r"x1 ∈ [-1.5, 4], x2 ∈ [-3, 4]",
        latex=r"f_{\text{McCormick}}(\mathbf{x}) = - x_{1} + 2 x_{2} + \left(x_{1} - x_{2}\right)^{2} + \sin\left(x_{1} + x_{2}\right) + 1",
        links=[
        ...
        minima={r"f(x_i)": -1.913222954981037, r"\mathbf{x}": [-0.5471975602214493, -1.547197559268372]},
        minima_latex=r"f(x_i) = -1.913222954981037 for \mathbf{x} = [-0.5471975602214493, -1.547197559268372]",
        name="McCormick",
        references=[
            "Adorio, E. P., & Diliman, U. P. MVF - Multivariate Test Functions Library in C for Unconstrained Global Optimization (2005). Retrieved June 2013, from http://http://www.geocities.ws/eadorio/mvf.pdf.",
    ...
    dict(
        dimensions="*",
        domain=[-4, 5],
        domain_latex=r"x_i \in [-4, 5], i=1,...,4",
        latex=r"f_{\text{Powell}}(\mathbf{x}) = (x_3+10x_1)^2+5(x_2-x_4)^2+(x_1-2x_2)^4+10(x_3-x_4)^4",
        links=[
        ...
        minima={r"f(x_i)": 0, r"x_i": 0},
        minima_latex=r"f(x_i) = 0 for x_i = 0 for i=1,...,4",
        name="Powell",
        references=[
            "Momin Jamil and Xin-She Yang, A literature survey of benchmark functions for global optimization problems, Int. Journal of Mathematical Modelling and Numerical Optimisation}, Vol. 4, No. 2, pp. 150--194 (2013), [arXiv:1308.4008",
    ...
    dict(
        dimensions="*",
        domain=[-500, 500],
        domain_latex=r"x_i \in [-500, 500], i=1,...,n",
        latex=r"f_{\text{Qing}}(\mathbf{x}) = \sum_{i=1}^{n} (x_i^2 - i)^2",
        links=[
        ...
        minima={r"f(x_i)": 0, r"x_i": r"\pm \sqrt(i)"},
        minima_latex=r"f(x_i) = 0 for x_i = \pm \sqrt(i) for i=1,...,n",
        name="Qing",
        references=[
            "Momin Jamil and Xin-She Yang, A literature survey of benchmark functions for global optimization problems, Int. Journal of Mathematical Modelling and Numerical Optimisation}, Vol. 4, No. 2, pp. 150--194 (2013), [arXiv:1308.4008",
    ...
    dict(
        dimensions="*",
        domain=[-5.12, 5.12],
        domain_latex=r"xi ∈ [-5.12, 5.12], for all i = 1, …, d",
        latex=r"f_{\text{Rastrigin}}(\mathbf{x}) = 10n \sum_{i=1}^n \left[ x_i^2 - 10 \cos(2\pi x_i) \right]",
        links=[
    ...
    dict(
        dimensions="*",
        domain=[-5, 10],
        domain_latex=r"xi ∈ [-5, 10], for all i = 1, …, d, although it may be restricted to the hypercube xi ∈ [-2.048, 2.048], for all i = 1, …, d",
        latex=r"f_{\text{Rosenbrock}}(\mathbf{x}) = \sum_{i=1}^{n-1} [100(x_i^2 - x_{i+1})^2 + (x_i - 1)^2]",
        links=[
    ...
    dict(
        dimensions="*",
        domain=[-100, 100],
        domain_latex=r"x_i \in [-100, 100], i=1,...,n",
        latex=r"f_{\text{Salomon}}(\mathbf{x}) = 1 - \cos \left (2 \pi \sqrt{\sum_{i=1}^{n} x_i^2} \right) + 0.1 \sqrt{\sum_{i=1}^n x_i^2}",
        links=[
    ...
    dict(
        dimensions=2,
        domain=[-100, 100],
        domain_latex=r"x_i \in [-100, 100], i=1,2",
        latex=r"f_{\text{Schaffer01}}(\mathbf{x}) = 0.5 + \frac{\sin^2 (x_1^2 + x_2^2)^2 - 0.5}{1 + 0.001(x_1^2 + x_2^2)^2}",
        links=[
    ...
    dict(
        ...
        domain=[-100, 100],
        domain_latex=r"xi ∈ [-100, 100], for all i = 1, 2",
        latex=r"f_{\text{Schaffer02}}(\mathbf{x}) = 0.5 + \frac{\sin^2 (x_1^2 - x_2^2)^2 - 0.5}{1 + 0.001(x_1^2 + x_2^2)^2}",
        links=[
    ...
    dict(
        ...
        domain=[-100, 100],
        domain_latex=r"x_i \in [-100, 100], i=1,2",
        latex=r"f_{\text{Schaffer03}}(\mathbf{x}) = 0.5 + \frac{\sin^2 \left( \cos \lvert x_1^2 - x_2^2 \rvert \right ) - 0.5}{1 + 0.001(x_1^2 + x_2^2)^2}",
        links=[
        ...
        minima={r"f(x_i)": 0.00156685, r"\mathbf{x}": [0, 1.253115]},
        minima_latex=r"f(x_i) = 0.00156685 for \mathbf{x} = [0, 1.253115]",
        name="Schaffer 3",
        references=[
            "S. K. Mishra, “Some New Test Functions For Global Optimization And Performance of Repulsive Particle Swarm Method,” [Available Online",
            "Momin Jamil and Xin-She Yang, A literature survey of benchmark functions for global optimization problems, Int. Journal of Mathematical Modelling and Numerical Optimisation}, Vol. 4, No. 2, pp. 150--194 (2013), [arXiv:1308.4008",
    ...
    dict(
        ...
        domain=[-100, 100],
        domain_latex=r"xi ∈ [-100, 100], for all i = 1, 2",
        latex=r"f_{\text{Schaffer04}}(\mathbf{x}) = 0.5 + \frac{\cos^2 \left( \sin(x_1^2 - x_2^2) \right ) - 0.5}{1 + 0.001(x_1^2 + x_2^2)^2}",
        links=[
        ...
        minima={r"f(x_i)": 0.292579, r"\mathbf{x}": [0, 1.253115]},
        minima_latex=r"f(x_i) = 0.292579 for \mathbf{x} = [0, 1.253115]",
        name="Schaffer 4",
        references=[
            "Test functions for optimization. In Wikipedia. Retrieved June 2013, from https://en.wikipedia.org/wiki/Test_functions_for_optimization.",
            "https://en.wikipedia.org/wiki/Test_functions_for_optimization",
    ...
    dict(
        dimensions="d",
        domain=[-100, 100],
        domain_latex=r"xi ∈ [-500, 500], for all i = 1, …, d",
        latex=r"f_{\text{Schwefel01}}(\mathbf{x}) = \left(\sum_{i=1}^n x_i^2 \right)^{\alpha}",
        links=[
    ...
    dict(
        ...
        domain=[-100, 100],
        domain_latex=r"x_i \in [-100, 100], i=1,...,n",
        latex=r"f_{\text{Schwefel20}}(\mathbf{x}) = \sum_{i=1}^n \lvert x_i \rvert",
        links=[
    ...
    dict(
        ...
        domain=[-100, 100],
        domain_latex=r"x_i \in [-100, 100], i=1,...,n",
        latex=r"f_{\text{Schwefel21}}(\mathbf{x}) = \smash{\displaystyle\max_{1 \leq i \leq n}} \lvert x_i \rvert",
        links=[
    ...
    dict(
        dimensions=2,
        domain=[-10, 10],
        domain_latex=r"xi ∈ [-10, 10], for all i = 1, 2, although this may be restricted to the square xi ∈ [-5.12, 5.12], for all i = 1, 2",
    ...
    dict(
        ...
        domain=[-10, 10],
        domain_latex=r"x_i \in [-10, 10], i=1,...,n",
        latex=r"f_{\text{Shubert03}}(\mathbf{x}) = \sum_{i=1}^n \sum_{j=1}^5 j \sin \left[(j+1)x_i \right] + j",
        links=[
        ...
        minima={r"f(x_i)": -24.062499, r"\mathbf{x}": [5.791794, 5.791794]},
        minima_latex=r"f(x_i) = -24.062499 for \mathbf{x} = [5.791794, 5.791794] (and many others).",
        name="Shubert 3",
        references=[
            "Momin Jamil and Xin-She Yang, A literature survey of benchmark functions for global optimization problems, Int. Journal of Mathematical Modelling and Numerical Optimisation}, Vol. 4, No. 2, pp. 150--194 (2013), [arXiv:1308.4008",
            "E. P. Adorio, U. P. Dilman, “MVF - Multivariate Test Function Library in C for Unconstrained Global Optimization Methods,” [Available Online",
    ...
    dict(
        ...
        domain=[-1, 1],
        domain_latex=r"xi ∈ [-5.12, 5.12], for all i = 1, …, d",
        latex=r"f_{\text{Sphere}}(\mathbf{x}) = \sum_{i=1}^{n} x_i^2",
        links=[
    ...
    dict(
        dimensions="*",
        domain=[-5, 5],
        domain_latex=r"xi ∈ [-5, 5], for all i = 1, …, d",
        latex=r"f_{\text{StyblinskiTang}}(\mathbf{x}) = \sum_{i=1}^{n} \left(x_i^4 - 16x_i^2 + 5x_i \right)",
        links=[
        ...
        minima={r"f(x_i)": r"-39.16616570377142n", r"x_i": -2.903534018185960},
        minima_latex=r"f(x_i) = -39.16616570377142n for x_i = -2.903534018185960 for i=1,...,n",
    ...
    dict(
        dimensions="*",
        domain=[-10, 10],
        domain_latex=r"xi ∈ [-10, 10], for all i = 1, …, d, although this may be restricted to the hypercube xi ∈ [-5.12, 5.12], for all i = 1, …, d",
    ...
    dict(
        dimensions=2,
        domain=[-5, 5],
        domain_latex=r"xi ∈ [-5, 5], for all i = 1, 2",
        latex=r"f_{\text{ThreeHumpCamel}}(\mathbf{x}) = 2x_1^2 - 1.05x_1^4 + \frac{x_1^6}{6} + x_1x_2 + x_2^2",
        links=[
    ...
    dict(
        dimensions=3,
        domain=[0, 2],
        domain_latex=r"x_i \in [0, 2], i=1,2,3",
        latex=r"f_{\text{Wolfe}}(\mathbf{x}) = \frac{4}{3}(x_1^2 + x_2^2 - x_1x_2)^{0.75} + x_3",
        links=[
        ...
        minima={r"f(x_i)": 0, r"x_i": 0},
        minima_latex=r"f(x_i) = 0 for x_i = 0 for i=1,2,3",
        name="Wolfe",
        references=[
            "Momin Jamil and Xin-She Yang, A literature survey of benchmark functions for global optimization problems, Int. Journal of Mathematical Modelling and Numerical Optimisation}, Vol. 4, No. 2, pp. 150--194 (2013), [arXiv:1308.4008",
            "H. P. Schwefel, “Numerical Optimization for Computer Models,” John Wiley Sons, 1981",
    ...
    dict(
        dimensions="*",
        domain=[-5, 5],
        domain_latex=r"x_i \in [-5, 5], i=1,...,n",
        latex=r"f_{\text{XinSheYang01}}(\mathbf{x}) = \sum_{i=1}^{n} \epsilon_i \lvert x_i \rvert^i",
        links=[
    ...
    dict(
        dimensions="*",
        domain=[-2*np.pi, 2*np.pi],
        domain_latex=r"x_i \in [-2\pi, 2\pi], i=1,...,n",
        latex=r"f_{\text{XinSheYang02}}(\mathbf{x}) = \frac{\sum_{i=1}^{n} \lvert{x_{i}}\rvert}{e^{\sum_{i=1}^{n} \sin\left(x_{i}^{2.0}\right)}}",
        links=[
    ...
    dict(
        dimensions="*",
        domain=[-20, 20],
        domain_latex=r"x_i \in [-20, 20], i=1,...,n",
        latex=r"f_{\text{XinSheYang03}}(\mathbf{x}) = e^{-\sum_{i=1}^{n} (x_i/\beta)^{2m}} - 2e^{-\sum_{i=1}^{n} x_i^2} \prod_{i=1}^{n} \cos^2(x_i)",
        links=[
    ...
    dict(
        ...
        domain=[-10, 10],
        domain_latex=r"x_i \in [-10, 10], i=1,...,n",
        latex=r"f_{\text{XinSheYang04}}(\mathbf{x}) = \left[ \sum_{i=1}^{n} \sin^2(x_i) - e^{-\sum_{i=1}^{n} x_i^2} \right ] e^{-\sum_{i=1}^{n} \sin^2 \sqrt{ \lvert x_i \rvert }}",
        links=[
    ...
    dict(
        dimensions="*",
        domain=[-5, 10],
        domain_latex=r"xi ∈ [-5, 10], for all i = 1, …, d",
        latex=r"f_{\text{Zacharov}}(\mathbf{x}) = \sum_{i=1}^{n} x_i^2 + \left ( \frac{1}{2} \sum_{i=1}^{n} i x_i \right )^2 + \left ( \frac{1}{2} \sum_{i=1}^{n} i x_i \right )^4",
        links=[
